        ...
        <>
            <div className='w-full h-[650px]'>
                <div className='w-full h-full'>
                    ...
                    <img src="public/hero.jpg" alt="HeroBanner" className="h-full object-top object-cover w-full" />
                </div>
            </div>
            ...
            <div className='absolute w-full top-[35%] p-10 '>
                ...
                <ul className='flex flex-row text-white text-sm mt-4'>
                    <li className='mr-4 mx-1 text-white'><img src='public/react.svg' className='h-8'/></li>
                    <li className='mr-4 mx-1 text-white'><img src='public/firebase.svg' className='h-9'/></li>
                    <li className='mr-4 mx-1 text-white'><img src='public/nextjs.svg' className='h-9'/></li>
                    <li className='mr-4 mx-1 text-white'><img src='https://git-scm.com/images/logos/downloads/Git-Icon-White.png' className='h-8'/></li>
                    <li className='mr-4 mx-1 text-white'><img src='public/tailwind.svg' className='h-10'/></li>
                </ul>
                ...
                <div className='mt-8 mb-2'>
                    ...
                    <img  className='inline mx-1 h-6 mb-0.5'src='public/play-button.png'/>Play</button>
                    <button className='capitlize bg-opacity-40 hover:bg-opacity-20 bg-white font-bold text-white py-2 px-5 rounded ml-4'><img  className='inline mx-1 h-6 mb-0.5' src='public/info-48.png'/>More Info</button>
                </div>
            </div>
        </>
    )
