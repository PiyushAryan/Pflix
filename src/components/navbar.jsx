...
function Navbar() {
  ...
  <div className="max-w-screen-xl flex items-center justify-between mx-auto p-4">
    <NavLink to="/Home" className="flex items-center space-x-3 rtl:space-x-reverse">
      <img src="public/logo.png" className="h-8" alt="Netflix Logo" />
        ...
        <ul className='space-x-4 flex-row flex p-0 mt-0' >
          <li>
          <img src="public\search.svg" className="h-6 hover:bg-opacity-20" alt="Search" />
          </li>
          <li>
          <img src="spublic\notify.png" className="h-6 hover:bg-opacity-20 relative" alt="notification" />
          </li>
          <li>
          <Link to={'https://www.github.com/PiyushAryan/'}><img className='h-6 hover:bg-opacity-20 relative' alt='github' src='public/github.svg'/></Link>
          </li> 
          <li>
          <Link to={'https://www.linkedin.com/in/piyush-aryan/'}><img className='h-6 hover:bg-opacity-20 relative' alt='linkedin' src='public/linkedin.svg'/></Link>
          </li>  
          <li>
