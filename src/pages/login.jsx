          ...
          <ul className="flex justify-center">
            <li className="mr-4 my-10">
              <Link to='/Home'><div className='group'>
                <img className='h-36 group-hover:animate-pulse shadow-gray-800 shadow-md ease-in-out duration-200 object-cover rounded ring ring-black group-hover:ring-white' src="src/assets/1679989398421.jpg" alt="Avatar" />
